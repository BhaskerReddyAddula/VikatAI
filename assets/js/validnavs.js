...
(function($) {
    ...
    var validnavs = {
        ...
        hoverDropdown: function() {
            ...
            if (getWindow < 1023) {
                ...
                // *** NEW: make the collapsed nav scrollable on mobile ***
                var headerH = getNav.outerHeight() || 75;
                $('.navbar-collapse.collapse-mobile, .navbar-collapse.show')
                    .css({
                        'max-height': (getHeight - headerH) + 'px',
                        'overflow-y': 'auto'
                    });
                ...
                // Enable click attribute navigation
                $("nav.navbar.validnavs .attr-nav").each(function() {
                ...
                $(".navbar-toggle").each(function() {
                    ...
                    $(this).on("click", function() {
                        ...
                        // re-apply scrollable height when menu is opened
                        var headerH2 = getNav.outerHeight() || 75;
                        var winH2 = $(window).height();
                        $('.navbar-collapse.collapse-mobile, .navbar-collapse.show')
                            .css({
                                'max-height': (winH2 - headerH2) + 'px',
                                'overflow-y': 'auto'
                            });
                    });
                });
                ...
                // NOTE: per-link close logic is handled in the smooth-scroll block.
                ...
                // Reset mobile-specific scroll hack on desktop
                $('.navbar-collapse').css({
                    'max-height': '',
                    'overflow-y': ''
                });
    ...
    /* ==================================================
    # Smooth Scroll (main + dropdown, central handler)
    ===============================================*/
    (function() {

        $(document).on(
            'click.validnavsScroll',
            'nav.navbar.validnavs .nav a[href^="#"]',
            function(event) {
                ...
                var $nav = $('nav.navbar.validnavs.navbar-sticky');
                var headerH = $nav.outerHeight() || 75;
                ...
                if ($(window).width() < 1023) {
                    ...
                    var $collapse = $('#navbar-menu');
                    $collapse
                        .removeClass('show in on hide_menu')
                        .addClass('hide_menu');
